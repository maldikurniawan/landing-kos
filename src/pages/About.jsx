...
const About = () => {
  ...
  return (
    <div id="About" className="h-fit bg-white grid grid-cols-1 md:grid-cols-12 px-6 py-16 md:px-[80px] md:py-[5rem] gap-6">
      <div className="col-span-full md:col-span-6" data-aos="fade-down-right" data-aos-delay="100">
      ...
      <div className="col-span-full md:col-span-6" data-aos="fade-down-left" data-aos-delay="100">
